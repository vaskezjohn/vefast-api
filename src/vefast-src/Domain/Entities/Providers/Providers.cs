...
namespace vefast_src.Domain.Entities.Providers
{
    ...
    public class Providers : BaseEntity
    {
        ...
        [Required]
        [ForeignKey("BookkeepingEntry")]
        public string ID_ImputationDebit { get; set; }
        [Required]
        [ForeignKey("BookkeepingEntry")]
        public string ID_ImputationCredit { get; set; }
        public virtual BookkeepingEntries BookkeepingEntry { get; set; }
